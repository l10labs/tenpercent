import { RpcProvider, Account, Contract, provider } from 'starknet';
...
let account_address = "0x4184158a64a82eb982ff702e4041a49db16fa3a18229aac4ce88c832baf56e4";
let account_private_key = "0x6bf3604bcb41fed6c42bcca5436eeb65083a982ff65db0dc123f65358008b51";
...
let actions_contract = new Contract(
    actions_abi,
    actions_contract_address,
    katana_provider,
);

export { katana_provider, katana_account, actions_contract };